...
contract DiamondInit {
    ...
    function init(uint256 _marketplaceFeeBps, address _treasury) external {
        // adding ERC165 data
        ...
        require(_marketplaceFeeBps <= 2500, "Fee too high at launch"); // Example: max 25% to start
        require(_treasury != address(0), "Invalid treasury address");
        ms.marketplaceFeeBps = _marketplaceFeeBps;
        ms.treasury = _treasury;
        ms.reentrancyStatus = 1;
